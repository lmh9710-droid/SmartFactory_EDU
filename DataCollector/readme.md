...
본 프로젝트는 임베디드 센서에서 계측한 데이터를 PC 미들웨어가 수집·저장하고, 웹 대시보드로 실시간 모니터링하는 **MES(제조실행시스템) 확장 기능**을 구현합니다.

| 단계 | 내용 |
| :---: | :--- |
| 🔧 **임베디드 센서 제어** | 임베디드 하드웨어의 센서 제어 펌웨어 로직 구현 |
| 💾 **미들웨어 데이터 적재** | UART 통신으로 수신한 센서 데이터를 PC 환경에서 Read → SQLite DB에 저장 |
| 📊 **실시간 모니터링** | SQLite에 저장된 센서 계측 데이터를 웹 대시보드(Streamlit)로 실시간 시각화 |
...
### 2️⃣ Middleware (C++ 데이터 수집기) 구조 설계
...
<div align="center">
<img width="900" alt="Class Diagram" src="https://github.com/user-attachments/assets/73ff1b65-36d8-4183-9a72-ec557bad8bfe" />
</div>
...
<b>1) 임베디드 하드웨어 구성</b><br><br>
<img width="100%" alt="Embedded Hardware" src="https://github.com/user-attachments/assets/55aa8bb2-5f22-49ae-bfea-6f084f8f3713" />
</td>
<td align="center" width="50%">
<b>2) C++ 미들웨어 데이터 통신 동작</b><br><br>
<img width="100%" alt="Middleware Communication" src="https://github.com/user-attachments/assets/1f7ef04d-4645-4915-b9c4-2c2bb1954d5f" />
</td>
</tr>
<tr>
<td align="center" width="50%">
<b>3) 공정 1번 (Thread 1) 모니터링</b><br><br>
<img width="100%" alt="Thread 1 Monitoring" src="https://github.com/user-attachments/assets/6e297107-1137-4d3f-b214-6c4a4192dcbd" />
</td>
<td align="center" width="50%">
<b>4) 공정 2번 (Thread 2) 모니터링</b><br><br>
<img width="100%" alt="Thread 2 Monitoring" src="https://github.com/user-attachments/assets/aae84e5f-cd3b-4e95-b5c5-772c39dd457d" />
</td>
</tr>
</table>
...
**Made with ❤️ for MES Sensor Data Pipeline**
